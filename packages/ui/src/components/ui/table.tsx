...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto">
      <table ref={ref} className={cn("w-full caption-bottom text-body-14", className)} {...props} />
    </div>
  ),
);
...
>(({ className, ...props }, ref) => (
  <caption ref={ref} className={cn("mt-4 text-body-14 text-muted-foreground", className)} {...props} />
));
