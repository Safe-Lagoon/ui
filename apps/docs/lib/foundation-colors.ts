...
export const foundationColorGroups: FoundationColorGroup[] = [
  {
    ...
    colors: [
      ...
      { name: "Lilac Hover", token: "lilac-hover", className: "bg-lilac-hover", hex: "#A86AEE" },
      ...
      { name: "Lilac Soft", token: "lilac-soft", className: "bg-lilac-soft", hex: "#F3E8FF", bordered: true },
      { name: "Brand Blue", token: "brand-blue", className: "bg-brand-blue", hex: "#2F77EE", description: "Links, accent" },
      { name: "Brand Blue Soft", token: "brand-blue-soft", className: "bg-brand-blue-soft", hex: "#E8F0FE", bordered: true },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Success Strong", token: "success-strong", className: "bg-success-strong", hex: "#30A46C" },
      { name: "Success Soft", token: "success-soft", className: "bg-success-soft", hex: "#E8F8EF", bordered: true },
      { name: "Warning", token: "warning", className: "bg-warning", hex: "#F5A524" },
      { name: "Warning Soft", token: "warning-soft", className: "bg-warning-soft", hex: "#FFF6E5", bordered: true },
    ],
  },
  {
    ...
    colors: [
      ...
      { name: "Canvas", token: "canvas", className: "bg-canvas", hex: "#E8ECEF", bordered: true },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Destructive Soft", token: "destructive-soft", className: "bg-destructive-soft", hex: "#FDECEA", bordered: true },
