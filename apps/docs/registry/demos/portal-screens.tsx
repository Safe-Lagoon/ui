...
export function navSection(screen: PortalScreen): "home" | "feed" | "rules" | "settings" | "" {
  if (screen === "/auth") return "";
  if (screen.startsWith("/feed")) return "feed";
  if (screen.startsWith("/rules")) return "rules";
  if (screen.startsWith("/settings")) return "settings";
  return "home";
}
